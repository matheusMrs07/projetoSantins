...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/universities/load', [UniversitiesController::class, 'load'])->name('universities.load');
	Route::get('/universities/create', [UniversitiesController::class, 'create'])->name('universities.create');
	Route::get('/universities/{id}', [UniversitiesController::class, 'show'])->name('universities.show');
	Route::post('/universities', [UniversitiesController::class, 'store'])->name('universities.store');


	Route::get('subscriptions', [SubscriptionController::class, 'index'])->name('subscriptions.index');
	Route::post('/universities/{id}/subscriptions', [SubscriptionController::class, 'store'])->name('subscriptions.store');
